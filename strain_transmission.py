...
## modification
### get_precomputed_threshold, get_threshold: if there is no available transmission threshold, use 0.1
...
def get_threshold(training_distances, distr_threshold):
    ...
    distances.sort()
    if distr_threshold == 999:
        return distances[int(len(distances)*0.1)]
    else:
